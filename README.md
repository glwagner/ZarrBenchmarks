...
Plot script: [`bench/plot_v3.jl`](bench/plot_v3.jl).

![v3 throughput vs data size](results/v3_throughput_vs_size.png)
...
The optimized Zarr.jl v3 path is configured by pinning Zarr via
`[sources]` in `Project.toml` to a local checkout of the all-combined
optimization branch. See
[`glw/zarr-v3-fullchunk`](https://github.com/glwagner/ZarrBenchmarks/tree/glw/zarr-v3-fullchunk)
for the reproducer. Per-proposal variants:
[`glw/zarr-propA`](https://github.com/glwagner/ZarrBenchmarks/tree/glw/zarr-propA),
[`glw/zarr-v3-bytes`](https://github.com/glwagner/ZarrBenchmarks/tree/glw/zarr-v3-bytes).
